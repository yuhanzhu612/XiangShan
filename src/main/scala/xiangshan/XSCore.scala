...
class XSCoreImp(outer: XSCoreBase) extends LazyModuleImp(outer)
  ...
  moniter.io.frontend_signals <> frontend.io_moniter
  moniter.io.wb_signals <> ctrlBlock.io_wb_moniter
  moniter.io.commit_signals <> ctrlBlock.io_commit_moniter
  moniter.io.excpt_signals  <> ctrlBlock.io_except_moniter
